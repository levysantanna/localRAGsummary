#!/usr/bin/env python3
"""
Sistema RAG Local Puro - 100% Open Source
...
def processar_documentos():
    ...
    processor.process_all_files(directory, max_files=50)
...
def fazer_consulta():
    ...
    for i, source in enumerate(result['sources'], 1):
        print(f"  {i}. Similaridade: {source['similarity']:.3f}")
